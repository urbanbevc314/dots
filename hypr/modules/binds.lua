...
hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd("/home/pi/.config/waybar/scripts/launch.sh"))
hl.bind(mainMod .. " + J", hl.dsp.layout("togglesplit"))    -- dwindle only

hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("/home/pi/.config/hypr/lock.sh"))
...
hl.bind("SHIFT + XF86MonBrightnessUp",  hl.dsp.exec_cmd("hyprctl hyprsunset temperature +150"),    { locked = true, repeating = true })
hl.bind("SHIFT + XF86MonBrightnessDown",hl.dsp.exec_cmd("hyprctl hyprsunset temperature -150"),    { locked = true, repeating = true })
